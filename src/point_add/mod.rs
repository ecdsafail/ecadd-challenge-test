...
pub fn build() -> Vec<Op> {
    ...
    // Cost-search composition: exact cache lifetimes, shared decoder echoes,
    // predicate factoring and analytic support pruning; no additional qubits.
    for name in ["Q796_R01_CACHE","Q796_R01_CLEAN","Q796_PREFIX_MASK_LOAN","Q796_SIGN_MASK_LOAN","Q796_DECODER_TRANSITION","Q796_DECODER_ANF","Q796_ENTRY_FACTOR","Q796_R00_CACHE","Q796_R00_SUPPORT"] {set_default_env(name,"1");}
    set_default_env("Q796_STEP_CANCEL_WINDOW","4096");
    set_default_env("Q796_TARGET_FACTOR","0");
