...
pub fn mod_mul_canonical_mbu_undo(
    ...
    for i in 0..255 {
        crate::point_add::trailmix_port::mod_arith::controlled_mod_sub_canonical_mbu_with_phase_lender(
            circ, &b[i], result, a,phase_lender,
        );
        crate::point_add::trailmix_port::mod_arith::mod_halve_canonical_mbu(circ, result);
    }
    crate::point_add::trailmix_port::mod_arith::controlled_mod_sub_canonical_mbu_with_phase_lender(
        circ, &b[255], result, a,phase_lender,
    );
