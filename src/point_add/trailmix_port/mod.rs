...
pub mod inversion {
    ...
    mod runtime_threshold_programs;
...
pub fn build_builder() -> crate::point_add::B {
    ...
    let ops_capacity = if inversion::paper2607_eea::optimized_shared_configuration() {
    ...
    if inversion::paper2607_eea::optimized_shared_configuration() {
