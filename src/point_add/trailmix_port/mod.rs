...
pub fn build_builder() -> crate::point_add::B {
    ...
    if inversion::rank5_lifecycle::enabled() {
        let selected_peak=if inversion::q796_parity::enabled(){796}else{797};
        ...
        if inversion::rank5_lifecycle::candidate_configuration(){
            assert_eq!(builder.current_ops_len(),inversion::rank5_lifecycle::CANDIDATE_OPS+3*novelty_pad_qubits,"Q796 candidate op-count drift");
            assert_eq!(builder.counted_kind_ops[OperationType::CCX as usize]+builder.counted_kind_ops[OperationType::CCZ as usize],inversion::rank5_lifecycle::CANDIDATE_TOFFOLI,"Q796 candidate Toffoli drift");
        }
