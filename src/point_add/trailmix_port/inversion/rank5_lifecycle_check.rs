...
pub fn run(){
 ...
 let peak=if super::super::q796_parity::enabled(){796}else{797};assert_eq!(circ.b.active_qubits,513);assert_eq!(circ.b.peak_qubits,peak);assert_eq!(circ.b.next_qubit,peak);let owned=circ.b.next_qubit as usize;let bits=circ.b.next_bit as usize;
