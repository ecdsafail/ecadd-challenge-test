...
pub fn run(){
 ...
 assert_eq!(circ.b.active_qubits,513);assert_eq!(circ.b.peak_qubits,799);assert_eq!(circ.b.next_qubit,799);let owned=circ.b.next_qubit as usize;let bits=circ.b.next_bit as usize;
 ...
 eprintln!("RANK5_LIFECYCLE_PASS inputs={count} lanes={} peak_qubits=799 forward_ops={forward_ops} forward_T={forward_t} lifecycle_ops={lifecycle_ops}; actual init/full forward/release/independent inverse/sign/rebuild/full inverse/finish, all256 passengers restored, every reset checked; NOT whole point-add or official9024",64*batches);
}
