...
const STREAM_RECORDS_PER_TRAVERSAL: usize = 112_323_915;
const STREAM_X_PER_TRAVERSAL: usize = 31_764_588;
const STREAM_CX_PER_TRAVERSAL: usize = 24_123_612;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 50_277_243;
